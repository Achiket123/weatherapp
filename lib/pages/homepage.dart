...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ListOFWeatherBloc, List<Weather>>(
      builder: (context, state) {
        
      
        return Scaffold(
          body: LiquidPullToRefresh(
            color: Color.fromARGB(46, 7, 61, 255),
            backgroundColor: Color.fromARGB(30, 7, 94, 255),
            onRefresh: () async {
              backend();
            },
            child: ListView(
              children: [
                      ...
                      Align(
                        ...
                        child: SizedBox(
                          ...
                          child: ScrollSnapList(
                            ...
                            itemBuilder: (p0, p1) =>
                                MainWeatherBox(weather: listofWeather[p1]),
                          ),
                        ),
                      ),
                    ],
                ...
                Align(
                  ...
                  child: SizedBox(
                      height: 160,
                      child: BlocBuilder<listofMiniWeatherBloc, List<MiniWeatherModel>>(
                        builder: (context, state) {
